...
def train():
    ...
    if data_args.data_path.endswith(".json") or data_args.data_path.endswith(".jsonl"):
        data = load_dataset("json", data_files=data_args.data_path, cache_dir=training_args.cache_dir)
    else:
        data = load_dataset(data_args.data_path, cache_dir=training_args.cache_dir)
